...
BED_LAYOUT_CONFIGS: list[dict[str, Any]] = [
    ...
    {
        "key": "NAT_PROXY_ENABLED",
        "default": False,
        "type": bool,
        "help": "是否启用内网穿透代理 | True: 启用, False: 禁用",
    },
    {
        "key": "NAT_PROXY_HOST",
        "default": "",
        "type": str,
        "help": "内网穿透公网地址 | 如: example.com 或 123.123.123.123",
    },
    {
        "key": "NAT_PROXY_PORT",
        "default": None,
        "type": int | None,
        "help": "内网穿透公网端口(可选) | 如: 9999，留空则自动判断",
    },
    {
        "key": "NAT_PROXY_USE_HTTPS",
        "default": False,
        "type": bool,
        "help": "内网穿透是否使用HTTPS | True: 使用https://, False: 使用http://",
    },
    {
        "key": "ENABLE_HTTPS",
        "default": False,
