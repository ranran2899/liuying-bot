...
__all__ = [
    "BuiltinSkillpackRegistrar",
    "builtin_skillpack_registrar",
    "get_current_time",
    "get_game_info",
    "get_news",
    "get_weather",
...
class BuiltinSkillpackRegistrar:
    """内置技能包注册器

    封装内置单文件技能包的注册能力（新闻/天气/时间/Wiki/游戏信息），
    所有方法均为静态方法。
    """
    ...
    def register_builtin_skillpacks(registry) -> int:
        ...
        tools: list[AgentTool] = [
            AgentTool(
                ...
                func=get_news,
                intent_tags=[
                    INTENT_TAG_REALTIME, INTENT_TAG_NETWORK
                ],
            ...
            AgentTool(
                ...
                func=(
                    BuiltinSkillpackRegistrar.async_get_current_time
                ),
...
builtin_skillpack_registrar = BuiltinSkillpackRegistrar()
"""内置技能包注册器单例"""
