...
base_config = Config.get_config("plugin_switch", "CHANGE_GROUP_SWITCH_LEVEL")
...
__plugin_meta__ = PluginMetadata(
    ...
    extra=PluginExtraData(
        ...
        """,
        admin_level=base_config if base_config is not None else 2,
        configs=[
            RegisterConfig(
...
async def _(
    ...
    if session.group:
        ...
        if task.result:
            ...
            _type = BlockType.ALL
            match (block_type.result, block_type.available):
                case ("p" | "private", True):
